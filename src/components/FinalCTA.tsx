...
import { ArrowRight, Sparkles, Check, Clock, Shield, Zap, CreditCard } from "lucide-react";

// Link de pagamento do Stripe - Plano Completo
const STRIPE_LINKS = {
      ...
      <div className="relative max-w-4xl mx-auto px-5 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 animate-fade-in-up delay-200">
          ...
          <div className="relative glass-dark rounded-2xl p-6 border border-dourado/30 w-full sm:w-auto">
            <p className="text-cinza-400 text-sm mb-1">Mensal</p>
            <div className="flex items-baseline justify-center gap-1">
              <span className="text-3xl font-extrabold gradient-text">R$149</span>
              <span className="text-cinza-400 text-sm">/mês</span>
            </div>
            <p className="text-cinza-500 text-xs mt-1">Acesso total e ilimitado</p>
          </div>

          {/* Anual */}
          <div className="relative glass-dark rounded-2xl p-6 border border-verde/30 w-full sm:w-auto">
            ...
            <p className="text-cinza-400 text-sm mb-1">Anual</p>
            <div className="flex items-baseline justify-center gap-1">
              <span className="text-3xl font-extrabold text-white">R$1.430</span>
              <span className="text-cinza-400 text-sm">/ano</span>
            </div>
            <p className="text-cinza-500 text-xs mt-1">Equivale a R$119/mês</p>
          </div>
        </div>
